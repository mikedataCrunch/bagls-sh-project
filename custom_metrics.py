...
class MulticlassTruePositives(tf.keras.metrics.TruePositives):
...
class MulticlassTrueNegatives(tf.keras.metrics.TrueNegatives):
...
class MulticlassFalseNegatives(tf.keras.metrics.FalseNegatives):
...
class MulticlassFalsePositives(tf.keras.metrics.FalsePositives):
